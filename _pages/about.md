...
**Journal Reviewer:**   
- IEEE Transactions on Neural Networks and Learning Systems (TNNLS), IEEE Transactions on Big Data (TBD), Expert Systems with Applications (ESWA), Neural Networks, Neurocomputing, Engineering Applications of Artificial Intelligence (EAAI), Multimedia Systems, Data Science and Engineering (DSEJ), etc.
