![image](https://github.com/user-attachments/assets/7151df28-c55a-40bf-b6de-32234e97a8da)![image](https://github.com/user-attachments/assets/b725b902-d0a7-487e-b8e2-9110906459b7)![image](https://github.com/user-attachments/assets/a2b9a762-2d31-4f62-ae08-8f22eb5dd62d)---
permalink: /
title: ""
excerpt: ""
author_profile: true
...
# 📝 Publications 
#### Journal Papers
- ``Neural Netw. 2025`` [Modeling Document Causal Structure with a Hypergraph for Event Causality Identification](https://Jason-Xiang5231.github.io), Neural Networks (Elsevier), **W. Xiang**, C. Liu, B. Wang.
...
- ``ACL-Findings 2024`` [Encoding Hierarchical Schema via Concept Flow for Multifaceted Ideology Detection](https://Jason-Xiang5231.github.io), S. Liu, B. Wang, **W. Xiang**, H. Xu, M. Xu. 
...
- ``EMNLP-Findings 2024`` [What Would Happen Next? Predicting Consequences from An Event Causality Graph](https://Jason-Xiang5231.github.io), C. Zhan, **W. Xiang**, C. Liang, B. Wang.
