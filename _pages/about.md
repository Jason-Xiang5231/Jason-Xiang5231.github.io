...
**Journal Reviewer:**   
- IEEE Transactions on Neural Networks and Learning Systems (TNNLS), IEEE Transactions on Big Data (TBD), Information Fusion, Expert Systems with Applications (ESWA), Neural Networks, Neurocomputing, Engineering Applications of Artificial Intelligence (EAAI), Multimedia Systems, Computer Speech & Language (CSL), Data Science and Engineering (DSEJ), etc.
